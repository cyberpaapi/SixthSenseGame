...
Last verified: 2026-09-18 (Global usernames live: concurrent database claims, duplicate/rename/recovery/ownership checks and legacy-seat migration passed. Real two-browser Bollywood VS with registered identities passed on Vercel and Pages. Local full browser, identity/recovery, core/data/VS, room resume, touch/Race/presence/banner and all packaging checks passed. No new Android binary or physical iPhone test is claimed.)
