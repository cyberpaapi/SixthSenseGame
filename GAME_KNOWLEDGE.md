...
Last verified: 2026-09-19 (Unified messages: focused solo/all-multiplayer feedback, full browser, core/identity, Peek, presence, banner layout, keyboard touch, Race phone/landscape, syntax and client packaging checks passed locally. Vercel and GitHub Pages deployment and public message checks passed. No new Android binary or physical iPhone test.)
...
Sixth Sense is an original, mobile-first word deduction game with solo and private-room multiplayer. Standard-mode answers have six letters; Bollywood Race and Bollywood VS use 5–7-letter complete hit-film titles and actors’ first names. New puzzles have six standard guesses, followed by one optional Last Chance. Feedback is presented through both color and symbols:
...
| Bollywood VS | A two-player Bollywood duel using the same 579-answer, 5–7-letter bank as Bollywood Race. Choose 3, 5, 9 or Endless rounds. Both players share each answer; first solve wins one point and the existing 60% VS coin reward. Six guesses plus optional Last Chance, redacted opponent patterns, resume, hints and screen-away signals remain. Endless selection stays in the Bollywood pool after solves and forfeits, avoiding repeats until exhausted. No difficulty selector or multiplayer Skip. |
