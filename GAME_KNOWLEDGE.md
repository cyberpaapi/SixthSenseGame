...
- Vercel production: primary release target at `https://sixth-sense-game.vercel.app/`; runtime `20260831.3` contains the unified completion flow plus the current victory hoot, card-timed confetti cannon, and background applause release described above.
